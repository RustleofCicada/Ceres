...
static LPCWSTR font_name[] = 
{
    (LPCWSTR)"Console",          // DefaultFont
    (LPCWSTR)"Times New Roman",  // TriplexFont
    (LPCWSTR)"Small Fonts",      // SmallFont
    (LPCWSTR)"MS Sans Serif",    // SansSerifFont
    (LPCWSTR)"Arial",            // GothicFont
    (LPCWSTR)"Script",           // ScriptFont
    (LPCWSTR)"Times New Roman",  // SimplexFont
    (LPCWSTR)"Script",           // TriplexScriptFont
    (LPCWSTR)"Courier New",      // ComplexFont
    (LPCWSTR)"Times New Roman",  // EuropeanFont
    (LPCWSTR)"Courier New Bold", // BoldFont
};
